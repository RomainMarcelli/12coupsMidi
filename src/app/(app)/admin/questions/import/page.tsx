...
export default async function ImportQuestionsPage() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-6 p-4 sm:p-6 lg:p-8">
      ...
      <details className="rounded-xl border border-white/10 bg-card/50 p-4 text-sm text-cream/80">
        <summary className="cursor-pointer font-semibold text-gold">
          Format attendu
        </summary>
        <pre className="mt-3 overflow-x-auto rounded-md bg-midnight-deep p-3 text-xs">
{`[
  {
    "type": "quizz_2",
